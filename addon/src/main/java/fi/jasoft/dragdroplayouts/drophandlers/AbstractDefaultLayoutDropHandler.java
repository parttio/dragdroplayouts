...
public abstract class AbstractDefaultLayoutDropHandler implements DropHandler {
  ...
  /**
   * Handles a drop by a component which has an absolute layout as parent. In this case the
   * component is moved.
   * 
  ...
  protected void handleDropFromAbsoluteParentLayout(DragAndDropEvent event) {
    ...
    MouseEventDetails mouseUp =
        MouseEventDetails.deSerialize((String) details.getData(Constants.DROP_DETAIL_MOUSE_EVENT));

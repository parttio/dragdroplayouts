...
public class VDDHorizontalSplitPanelDropHandler extends VAbstractDropHandler {

    private final VDDHorizontalSplitPanel layout;

    private final ApplicationConnection client;

    public VDDHorizontalSplitPanelDropHandler(VDDHorizontalSplitPanel layout,

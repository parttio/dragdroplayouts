...
public class VDDFormLayout extends VFormLayout implements VHasDragMode,
    VDDHasDropHandler<VDDFormLayoutDropHandler>, DragStartListener, VHasDragFilter,
  ...
  protected void updateDragDetails(Widget widget, VDragEvent event) {
    ...
    event.getDropDetails().put(
        ...
        getVerticalDropLocation(
            VDDFormLayout.getRowFromChildElement(widget.getElement(),
    ...
    /*
     * Add Classname of component over the drag. This can be used by a a client side criteria to
     * verify that a drag is over a specific class of component.
     */
  ...
  protected void emphasis(Widget widget, VDragEvent event) {
     ...
     */
    Element rowElement =
        getRowFromChildElement(widget.getElement(), VDDFormLayout.this.getElement());
  ...
  public boolean dragStart(Widget widget, LayoutDragMode mode) {
    return ddMouseHandler.getDragMode() != LayoutDragMode.NONE && dragFilter.isDraggable(widget);
  }

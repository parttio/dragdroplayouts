...
public class DDTabSheet extends TabSheet implements LayoutDragSource, DropTarget, ShimSupport,
  ...
  public Transferable getTransferable(Map<String, Object> rawVariables) {
    if (rawVariables.get(Constants.TRANSFERABLE_DETAIL_INDEX) != null) {
      ...
      int index =
          Integer.parseInt(rawVariables.get(Constants.TRANSFERABLE_DETAIL_INDEX).toString());
      Iterator<Component> iter = getComponentIterator();
      int counter = 0;
      Component c = null;
      while (iter.hasNext()) {
